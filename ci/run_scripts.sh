...
if [ "$FENICS_VERSION" == "2018.1" ]; then
    ...
    PYTHON_PREPROC="export DOLFIN_NOPLOT=1; export MPLBACKEND=Agg; export hIPPYlibDeprecationWarning=error; echo 'webagg.address=0.0.0.0'>>.config/matplotlib/matplotlibrc"
