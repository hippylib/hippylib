...
deterministic and Bayesian inverse problems governed by partial differential equations (PDE).
...
of the deterministic and linearized Bayesian inverse problem is computed
...
`hIPPYlib` offers different scalable methods for sample generation.
...
by exploiting the assembly procedure of finite element matrices to construct a sparse
rectagular decomposition of the precision operator.
